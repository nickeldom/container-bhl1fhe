...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bhl1fhe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bhl1fhe.containers.anotherwebservice.com/
...
```
git clone git@github.com:nickeldom/container-bhl1fhe.git
cd container-bhl1fhe
```
...
```
docker attach container-bhl1fhe
```
